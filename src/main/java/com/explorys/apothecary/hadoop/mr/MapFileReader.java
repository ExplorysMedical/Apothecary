...
public class MapFileReader implements Closeable
{
	 ...
	 */
	protected MapFileReader(FileSystem fs, String dirName,
	 ...
	 */
	public synchronized void finalKey(WritableComparable key, ImmutableState state)
	  throws IOException {
	 ...
	 */
	private synchronized int seekInternal(WritableComparable key, ImmutableState state)
	  throws IOException {
	...
	public synchronized WritableComparable getClosest(WritableComparable key,
	  Writable val, ImmutableState state)
	throws IOException {
	 ...
	 */
	public synchronized WritableComparable getClosest(WritableComparable key,
	    Writable val, final boolean before, ImmutableState state)
	  throws IOException {
